...
# Single test
RUST_LOG=info cargo run --release -- -k 18 --function zkmain --output ./output --wasm wasm/wasm_output.wasm setup

RUST_LOG=info cargo run --release -- -k 18 --function zkmain --output ./output --wasm wasm/wasm_output.wasm single-prove --public 133:i64 --public 2:i64
