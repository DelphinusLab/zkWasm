...
lazy_static! {
    static ref OPCODE_CLASS_SHIFT: BigUint = BigUint::one() << OPCODE_CLASS;
    static ref OPCODE_U64_SHIFT: BigUint = BigUint::one() << u64::BITS;
    static ref OPCODE_U32_SHIFT: BigUint = BigUint::one() << u32::BITS;
    static ref OPCODE_U16_SHIFT: BigUint = BigUint::one() << u16::BITS;
    static ref OPCODE_UNIARG_SHIFT: BigUint = BigUint::one() << UNIARG_BITS;
...
impl EncoderType {
    ...
    fn shift(&self) -> &BigUint {
        match self {
            ...
            EncoderType::U16 => &OPCODE_U16_SHIFT,
...
pub fn encode_local_get<T: FromBn>(vtype: T, offset: T) -> T {
    Encoder::encode_without_uniarg(
        ...
        vec![(vtype, EncoderType::Bit), (offset, EncoderType::U16)],
    )
}
